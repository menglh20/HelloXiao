...
static BLEUUID serviceUUID("89c6a56a-3c49-403e-9694-3045df60eb85");
// The characteristic of the remote service we are interested in.
static BLEUUID    charUUID("0b23ea84-8a96-45e5-b941-9f3cb7bbe557");
...
float parseDistanceFromPayload(const uint8_t* pData, size_t length) {
...
static void notifyCallback(
  ...
  float d = parseDistanceFromPayload(pData, length);
  ...
  if (!isnan(d)) {
    ...
    // If payload doesn't match expected format, still show raw
